...
```
node "${OMP_AGENT_DIR:-$HOME/.omp/agent}"/skills/impeccable/scripts/live-poll.mjs --stream   # stays running; one JSON line per event
...
```bash
node "${OMP_AGENT_DIR:-$HOME/.omp/agent}"/skills/impeccable/scripts/live-status.mjs
node "${OMP_AGENT_DIR:-$HOME/.omp/agent}"/skills/impeccable/scripts/live-resume.mjs --id SESSION_ID
node "${OMP_AGENT_DIR:-$HOME/.omp/agent}"/skills/impeccable/scripts/live-complete.mjs --id SESSION_ID
```
...
```bash
node "${OMP_AGENT_DIR:-$HOME/.omp/agent}"/skills/impeccable/scripts/live-poll.mjs --reply EVENT_ID error "Short reason"
```
...
```bash
node "${OMP_AGENT_DIR:-$HOME/.omp/agent}"/skills/impeccable/scripts/live-poll.mjs --reply EVENT_ID steer_done ["Optional short note for a browser toast"]
```
...
```bash
node "${OMP_AGENT_DIR:-$HOME/.omp/agent}"/skills/impeccable/scripts/detect-csp.mjs
```
